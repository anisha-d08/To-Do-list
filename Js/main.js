...
const getList = function (todoItems) {
    ...
    todoItems.forEach(function (item) {
        itemList.insertAdjacentHTML('beforeend', `<div class="item my-3"><h5 class="item-name text-capitalize">${item}</h5><div class="item-icons"><a href="#" class="complete-item mx-2 item-icon"><i class="fas fa-check"></i></a><a href="#" class="edit-item mx-2 item-icon"><i class="fas fa-pencil-alt"></i></a><a href="#" class="delete-item item-icon"><i class="fas fa-times"></i></a></div></div>`);
